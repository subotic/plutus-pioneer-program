...
import Plutus.Contract.Trace.RequestHandler (wrapHandler)
...
mkValidator _ MyRedeemer {flag1=flagOne, flag2=flagTwo} _ = traceIfFalse "redeemer flags not equal" $ flagOne == flagTwo
